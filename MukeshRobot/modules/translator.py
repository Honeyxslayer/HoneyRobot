...
def totranslate(update: Update, context: CallbackContext) -> None:
    ...
    if not reply_msg:
        message.reply_text(
            ...
            "ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ sᴇᴇ [ʟɪsᴛ ᴏғ ᴀᴠᴀɪʟᴀʙʟᴇ ʟᴀɴɢᴜᴀɢᴇ ᴄᴏᴅᴇs](https://t.me/Honey_networks/21).",
            parse_mode="markdown",
...
Mukesh = "https://graph.org/file/19c56a223d6cd16c4ea9e.jpg"
...
**ʜᴏɴᴇʏ ✘ ᴄᴏɴᴛʀᴏʟʟᴇʀ sᴏᴜʀᴄᴇ ɪs ɴᴏᴡ ᴩᴜʙʟɪᴄ ᴀɴᴅ ɴᴏᴡ ʏᴏᴜ ᴄᴀɴ ᴍᴀᴋᴇ ʏᴏᴜʀ ᴏᴡɴ ʙᴏᴛ.**
""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton(
                        "• ʀᴇᴘᴏ •",
                        url="https://graph.org/file/bd92b0a61368400419de4.mp4",
                    ),
                ]
            ]
        ),
